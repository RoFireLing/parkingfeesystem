...
public class DRTLog {
    ...
    public void recordResult(String filename,String fmesure,String nfmeasure,String tmeasure,
                             String sdrfmeasure,String sdrnfmeasure,String sdrtmeasure, int numOfpartitions,
                             double parametors,String mutantDistribution
        ...
        try{
            ...
            if (!file.exists()){
                try{
                    ...
                    String[] elements = {"MuDistribution","partitions","parameters","Fmeasure","sdr_Fmeasure","NFmeasure","sdr_NFmeasure","Tmeasure","sdr_Tmeasure","Ftime","F2time","Ttime"};
            ...
            sdrfmeasure,nfmeasure,sdrnfmeasure,tmeasure,sdrtmeasure,String.valueOf(ftime),String.valueOf(f2time),String.valueOf(ttime)};
            for (int i = 0; i < elements.length; i++) {
