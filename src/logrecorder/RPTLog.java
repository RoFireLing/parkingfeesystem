...
public class RPTLog {
    ...
    public void recordProcessInfo(String filename, String mutantDistribution, String seed,String partition,
        ...
        String content = "\n"+"\t"+mutantDistribution + "\t\t\t\t\t\t" + seed + "\t\t\t\t" + TCID + "\t\t\t\t"+partition
    ...
    public void recordResult(String filename, String mutantDistribution,String fmeasure,String nfmeasure,String tmeasure,
                             String sdrfmwasure,String sdrnfmwasure,String sdrtmeasure,String partition
    ...
    public static void main(String[] args) {
        ...
        lists.add("roa1");
        rptLog.recordProcessInfo("test","M50-50","1","1","1",lists,"10");
    }
}
